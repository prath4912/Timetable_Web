...
export default function Elective() {
  ...
  const getsubjects = async () => {
    const response = await axios.post(`${BaseUrl}/api/elective/get` , {dept , year});
